...
///https://lexicon.garden/lexicon/did:plc:4v4y5r3lwsbtmsxhile2ljac/app.bsky.graph.getKnownFollowers/docs
extension Lexicon.App.Bsky.Graph {
	public enum GetKnownFollowers: Atproto.XRPC.Request {
		public struct Id: Atproto.XRPC.EndpointId {
			public static var nsid: Atproto.NSID {
				.init(string: "app.bsky.graph.getKnownFollowers")
			}
		...
		public struct Output: Sendable, Codable {
			...
			public let cursor: String?
			public let followers: [Lexicon.App.Bsky.Actor.Defs.ProfileView]

			public init(
				subject: Lexicon.App.Bsky.Actor.Defs.ProfileView,
				cursor: String?,
				followers: [Lexicon.App.Bsky.Actor.Defs.ProfileView]
			) {
...
extension Lexicon.App.Bsky.Graph.GetKnownFollowers: Atproto.XRPC.ResponseParsing {
