...
///https://lexicon.garden/lexicon/did:plc:4v4y5r3lwsbtmsxhile2ljac/app.bsky.graph.getFollowers/docs
extension Lexicon.App.Bsky.Graph {
	public enum GetFollowers: Atproto.XRPC.Request {
		public struct Id: Atproto.XRPC.EndpointId {
			public static var nsid: Atproto.NSID {
				.init(string: "app.bsky.graph.getFollowers")
			}
...
extension Lexicon.App.Bsky.Graph.GetFollowers: Atproto.XRPC.ResponseParsing {
